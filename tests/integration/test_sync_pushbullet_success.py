...
def test_sync_triggers_pushbullet_success(patch_pushbullet_notify):
    ...
    # Simulate successful sync (replace with actual sync logic as needed)
    ...
    assert "successfully" in patch_pushbullet_notify.message
